...
def true_fail_prob(p, t, upper_t, a0=1.0, a1=5.0):
     return np.exp(- (p + a0 * t) / a1)

def true_mean_demand(p, t, upper_t, n_p=10):
    p_f = true_fail_prob(p, t, upper_t)
...
def observe_demand_negbinom(p, t, upper_t, n=10, random_state= None):
    return random_state.negative_binomial(n, 1 - true_fail_prob(p, t, upper_t))